	...
	//product queries
		 ...
		 // ticket queries
		  final static String GET_ALL_TICKETS = "SELECT * from tickets";
			 ...
			 final static String INSERT_TICKET = "INSERT into tickets (ticket_id,ticket_key,ticket_type_id,product_id,summary,assignee,reporter,priority,status,resolution,due_date,created,updated,component)	values(null,?,?,?,?,?,?,?,?,?,?,?,?,?)";
