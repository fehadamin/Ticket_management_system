...
public class User {
	...
	private String products_assigned;
	private String created;

	/**
	 * @return the products_assigned
	 */
	public String getProducts_assigned() {
		return products_assigned;
	}

	/**
	 * @param products_assigned the products_assigned to set
	 */
	public void setProducts_assigned(String products_assigned) {
		this.products_assigned = products_assigned;
	}
