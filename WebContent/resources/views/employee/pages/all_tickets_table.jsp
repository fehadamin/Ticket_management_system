...
%>
	...
	<div >
		...
		<form method="post" action="filter_ticket_side.htm">
			<label class="filterstext"> Status</label>
				   <select  name="status">
			...
			<label class="filterstext"> Priority</label>
			...
			<label class="filterstext"> Assignee</label>
			  ...
			  <input type="submit"  class="filters"   name="filter" />
				     <a  class="filters"  href="employee-ticket-all.htm">reset </a>
		</form>
	</div>
        ...
        <table id="mytable" class="myTable">
			...
			<tbody>
				...
				<tr>
					...
					<td><a
						href="<%=Url%>employee-ticket-edit-form.htm?id=<%=t.getTicketId()%>">edit</a>
						<a href="<%=Url%>employee-ticket-remove.htm?id=<%=t.getTicketId()%>">delete</a>
					</td>
